...
const PWAChats = () => {
  ...
  return (
    <PWAPageWrapper title="Chats">
      {/* Search Bar */}
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-xl px-4 py-3 border-b">
            ...
            return (
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-md overflow-hidden ring-2 ring-background bg-muted shadow-sm">
                    {conv.items?.images?.[0] ? (
                      <img 
                  ...
                  <div className="flex items-center justify-between gap-2 mb-0.5">
                    <div className="flex items-center gap-1.5 min-w-0">
                      ...
                      {otherUser.verification_status === 'approved' && (
                        <Shield className="h-3.5 w-3.5 fill-green-500 text-green-500 flex-shrink-0" />
                      )}
                    </div>
