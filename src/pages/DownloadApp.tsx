...
/* ── SEO constants ── */
const SEO = {
  title: 'MyCampusKart — Buy & Sell Used Stuff at LPU | Save ₹3,800/Semester',
  description:
    'MyCampusKart is the #1 student marketplace for LPU. Buy secondhand lab coats, cycles, calculators & textbooks from verified seniors. Save up to ₹7,040 a semester. Free. No commission.',
  canonical: 'https://www.mycampuskart.in/download',          // ← update to your real domain
  ogImage: 'https://www.mycampuskart.in/og-cover.png',        // ← update to a real 1200×630 image
  keywords:
    'LPU student marketplace, buy secondhand lab coat LPU, used cycle LPU, LPU student app, MyCampusKart, sell used books LPU, LPU hostel buy sell, secondhand calculator LPU, campus marketplace India',
};
...
function Ticker() {
  ...
  return (
    <div className="overflow-hidden bg-primary py-2.5 border-y border-primary/20" aria-hidden="true">
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:site_name" content="MyCampusKart" />
        ...
        <meta name="apple-mobile-web-app-title" content="MyCampusKart" />
      ...
      >
        ...
        {/* ── NAV ── */}
        <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-slate-100" aria-label="Main navigation">
          <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
            <a
              href="/"
              className="flex items-center gap-2.5"
              aria-label="MyCampusKart — LPU Student Marketplace Home"
              onClick={e => { e.preventDefault(); navigate('/'); }}
            >
              <img
                src={logo}
                alt="MyCampusKart logo — LPU student buy and sell marketplace"
            ...
            <div className="flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-widest text-primary">
              <span className="live-dot w-2 h-2 rounded-full bg-primary inline-block" aria-hidden="true" />
              LPU Only
            </div>
          </div>
        </nav>
        ...
        {/* ── HERO ── */}
        <section className="relative pt-14 pb-20 overflow-hidden" aria-labelledby="hero-heading">
          ...
          <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-[1fr_420px] gap-12 items-center">
            ...
            <div className="space-y-7 z-10">
              <div className="fade-up inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 text-primary text-[11px] font-extrabold uppercase tracking-[0.2em]">
                <Sparkles className="h-3 w-3" aria-hidden="true" /> For LPU Students Only
              </div>

              {/*
                SEO FIX: h1 now has meaningful, keyword-rich plain text.
                Visual styling kept exactly the same using aria-label on the section.
              */}
              <h1
                id="hero-heading"
                className="fade-up text-[58px] lg:text-[72px] font-extrabold leading-[0.92] tracking-tight"
                style={{ animationDelay: '0.08s' }}
              >
                Buy Used.{' '}
                <span className="serif italic" style={{ color: 'hsl(var(--primary))' }}>Stay Financially Alive</span>{' '}
                <span className="text-slate-400 font-light">at LPU.</span>
              </h1>

              {/* SEO: descriptive subheading as <p> keeps keyword density without breaking heading hierarchy */}
              <p className="fade-up text-[17px] text-slate-500 max-w-lg leading-relaxed" style={{ animationDelay: '0.16s' }}>
                MyCampusKart is the <strong>free student marketplace at LPU</strong> — buy and sell secondhand lab coats, cycles, calculators, and textbooks from verified seniors. Save an average of <strong>₹3,800 every semester</strong>.
              </p>
              ...
              <div className="fade-up" style={{ animationDelay: '0.3s' }}>
                ...
                <div className="flex items-center gap-5 mt-4 text-slate-400 text-[11px] font-bold uppercase tracking-widest">
                  <span className="flex gap-1.5 items-center"><CheckCircle className="h-3.5 w-3.5 text-green-500" aria-hidden="true" />Free Forever</span>
                  <span className="flex gap-1.5 items-center"><CheckCircle className="h-3.5 w-3.5 text-green-500" aria-hidden="true" />LPU Verified Students</span>
                  <span className="flex gap-1.5 items-center"><CheckCircle className="h-3.5 w-3.5 text-green-500" aria-hidden="true" />Zero Commission</span>
                </div>
              </div>
            </div>

            {/* RIGHT PHONE — decorative, hidden from screen readers */}
        ...
        {/* ── PRICE COMPARISON ── */}
        <section className="py-20 bg-white" aria-labelledby="price-heading">
          <div
            ref={s1}
          ...
          >
            <div className="text-center mb-12 space-y-2">
              ...
              <h2 id="price-heading" className="text-4xl font-extrabold tracking-tight">
                Secondhand Prices vs Store Prices at LPU
              </h2>
              <p className="text-slate-400 text-base">Your parents would cry if they knew what everything actually costs new vs. here.</p>
            </div>
        ...
        {/* ── MEME GRID ── */}
        <section className="py-20 bg-[#FAFAFA]" aria-labelledby="scenarios-heading">
          <div
            ref={s2}
          ...
          >
            <div className="text-center mb-12 space-y-2">
              ...
              <h2 id="scenarios-heading" className="text-4xl font-extrabold tracking-tight">
                Real LPU Student Situations MyCampusKart Fixes
              </h2>
        ...
        {/* ── DARK TRUTH ── */}
        <section className="py-20 bg-slate-900 text-white" aria-labelledby="features-heading">
          <div
            ref={s3}
          ...
          >
            ...
            <h2 id="features-heading" className="text-5xl font-extrabold leading-tight mb-6">
            ...
            <div className="grid md:grid-cols-3 gap-5 text-left">
              {[
                { icon: MapPin, title: "Meet in 200m — On-Campus Pickup", body: "Your seller lives in the next hostel block. No delivery. No waiting. No 'out for delivery since yesterday'.", color: "text-blue-400" },
                { icon: ShieldCheck, title: "LPU Students Only — Verified & Safe", body: "Everyone on here has a student ID. You know where they live. They know where you live. It's safe.", color: "text-green-400" },
                { icon: Zap, title: "Sell in Under 30 Minutes", body: "A graduating senior listed a cycle at 11 AM. It was gone by 11:23. Your stuff can move that fast too.", color: "text-yellow-400" },
        ...
        {/* ── HOW TO INSTALL ── */}
        <section className="py-20 bg-white" aria-labelledby="install-heading">
          <div
            ref={s4}
          ...
          >
            ...
            <h2 id="install-heading" className="text-4xl font-extrabold tracking-tight mb-2">
              Install MyCampusKart in 15 Seconds — No App Store Needed
            </h2>
            <p className="text-slate-400 mb-12">Faster than checking your attendance on UniConnect.</p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {[
                ...
                <div key={n} className="text-left p-6 rounded-3xl bg-slate-50 border border-slate-100 space-y-3 hover:shadow-md transition-shadow">
                  <p className="text-5xl font-extrabold text-primary/20 leading-none" aria-hidden="true">{n}</p>
            ...
            <button
              ...
              aria-label="Install MyCampusKart app now"
            >
        ...
        {/* ── FINAL FOMO ── */}
        <section className="py-24 bg-[#FAFAFA] border-t border-slate-100" aria-labelledby="fomo-heading">
          <div className="max-w-3xl mx-auto px-5 text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 border border-red-200 text-red-600 text-[11px] font-extrabold uppercase tracking-widest">
              <TrendingDown className="h-3.5 w-3.5" aria-hidden="true" /> Your savings are actively declining
            </div>

            <h2 id="fomo-heading" className="text-[56px] font-extrabold leading-[0.9] tracking-tight text-slate-900">
            ...
            <p className="text-slate-500 text-lg max-w-xl mx-auto">
              500+ LPU students are already on MyCampusKart. The ₹3,800 semester average isn't a number we made up. It's what your batchmates are saving. Every semester you don't use this is money gone.
            </p>
            ...
            <p className="text-slate-300 text-xs">
              No signup wall. No credit card. No selling your data. Just a marketplace that saves LPU students money.
            </p>
          </div>
        </section>
        ...
        <footer className="py-10 border-t border-slate-100 bg-white text-center space-y-3">
          <div className="flex items-center justify-center gap-2.5">
            <img
              src={logo}
              alt="MyCampusKart — LPU student marketplace"
          ...
          <p className="text-slate-300 text-xs">
            © 2026 MyCampusKart — Built by LPU students who paid full price in Year 1 and swore to fix it.
          </p>
        </footer>
