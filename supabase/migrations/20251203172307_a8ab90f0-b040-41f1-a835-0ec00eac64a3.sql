-- Update complete_order_with_confirmation to auto-mark item as sold and handle trust badge
...
BEGIN
    ...
    IF order_record.seller_confirmed AND order_record.buyer_confirmed THEN
        ...
        -- Increment deals_completed for seller and check trust badge
        UPDATE profiles
        SET 
        ...
        -- Increment deals for buyer too
        UPDATE profiles
        SET deals_completed = deals_completed + 1, updated_at = now()
